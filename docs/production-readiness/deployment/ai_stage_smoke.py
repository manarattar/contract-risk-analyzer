...
try:
 ...
 print(json.dumps({'passed':True,'synthetic_only':True,'finding_count':len(findings),'verified_quote_count':sum(len(f['citations']) for f in findings),'answer_quotes_verified':True,'reserved_cents':reserved,'model':'gpt-4.1-mini-2025-04-14','prompt_hash':PROMPT_HASH,'qualified_legal_evaluation':False}))
